...
manuscript2_yaml <- rmarkdown::yaml_front_matter("analysis/paper/001-reply-main.Rmd")
...
> `r paste(manuscript1$authors, "(submitted)", manuscript1$title)`
...
> Henning Teickner and Klaus-Holger Knorr, (`r format(Sys.Date(), "%Y")`). _Compendium of R code and data for "`r manuscript1_yaml$title`"_. Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at <https://doi.org/xxx/xxx>
...
The **analysis** directory contains:
  ...
  - [:file\_folder: paper](/analysis/paper): R Markdown source documents
    needed to reproduce the manuscript, including figures and tables. The main 
    script is [001-paper-main.Rmd](analysis/paper/001-paper-main.Rmd). Additional scripts are:
        ...
        - [008-paper-supplementary.Rmd](analysis/paper/008-paper-supplementary.Rmd): Computes supplementary analyses and figures.
...
You can download the compendium as a zip from from this URL: <https://doi.org/> ---todo
...
Running the whole script takes about two hours and occupies additional disk space of ~2 Gb.  
...
The [Dockerfile](Dockerfile) provides instructions how to build a Docker image from the Dockerfile and how to run the image in a Docker container. It occupies disk space of ~5 Gb.
